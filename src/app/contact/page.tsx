...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the CRUDkit team. We'd love to hear from you!",
  keywords: ['contact', 'support', 'help', 'feedback', 'CRUDkit'],
  openGraph: {
    title: 'Contact Us | CRUDkit',
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <a
                  href="https://github.com/tortoisewolfe/CRUDkit/discussions"
                  className="link link-primary flex items-center"
                  target="_blank"
                  rel="noopener noreferrer"
                >
