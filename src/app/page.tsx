        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex gap-3 justify-center lg:justify-start flex-wrap mb-8">
              ...
              <a href="/accessibility" className="btn btn-accent">
                Accessibility
              </a>
              <a href="/status" className="btn btn-info">
                Status
              </a>
            ...
            <div className="divider">Source Code</div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title text-primary">🎨 32 Themes</h2>
              <p className="text-sm">Light & dark variants with instant switching and persistence.</p>
            </div>
          </div>
          
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title text-secondary">📱 PWA Ready</h2>
              <p className="text-sm">Installable app with offline support and service worker.</p>
            </div>
          </div>
          
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title text-accent">♿ Accessible</h2>
              <p className="text-sm">WCAG compliant with customizable font size and spacing.</p>
            </div>
          </div>
        </div>
      </div>
