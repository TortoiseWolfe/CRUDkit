...
import { COLORBLIND_MATRICES, matrixToSVGString } from '@/utils/colorblind-matrices';
...
describe('ColorblindFilters', () => {
  ...
  it('should have correct color matrix for protanopia', () => {
    ...
    const expectedMatrix = matrixToSVGString(COLORBLIND_MATRICES[ColorblindType.PROTANOPIA]);
  ...
  it('should have correct color matrix for deuteranopia', () => {
    ...
    const expectedMatrix = matrixToSVGString(COLORBLIND_MATRICES[ColorblindType.DEUTERANOPIA]);
    expect(colorMatrix).toHaveAttribute('values', expectedMatrix);
  });
  ...
  it('should have correct color matrix for tritanopia', () => {
    ...
    const expectedMatrix = matrixToSVGString(COLORBLIND_MATRICES[ColorblindType.TRITANOPIA]);
    expect(colorMatrix).toHaveAttribute('values', expectedMatrix);
  });
  ...
  it('should have correct color matrix for achromatopsia', () => {
    ...
    const expectedMatrix = matrixToSVGString(COLORBLIND_MATRICES[ColorblindType.ACHROMATOPSIA]);
    expect(colorMatrix).toHaveAttribute('values', expectedMatrix);
  });
