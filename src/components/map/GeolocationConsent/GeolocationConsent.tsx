...
const purposeLabels: Record<GeolocationPurpose, string> = {
  ...
  [GeolocationPurpose.LOCATION_ANALYTICS]: 'Improve your experience with location analytics',
  [GeolocationPurpose.PERSONALIZATION]: 'Provide personalized content based on your location',
};
...
export const GeolocationConsent: React.FC<GeolocationConsentProps> = ({
  ...
  const [selectedPurposes, setSelectedPurposes] = useState<GeolocationPurpose[]>(purposes);
  ...
  return (
    <div className="modal modal-open" data-testid={testId}>
      ...
      >
        ...
        <h3 id="consent-title" className="font-bold text-lg">
          {title}
        </h3>
