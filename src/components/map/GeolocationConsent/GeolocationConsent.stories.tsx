...
export const LongDescription: Story = {
  args: {
    isOpen: true,
    description: 'This application uses your location data to provide you with a personalized experience. Your location helps us show you on the map, find nearby points of interest, provide relevant search results, and improve our services. We take your privacy seriously and only use your location when necessary.',
  },
};
...
export const AllFeatures: Story = {
  args: {
    ...
    description: 'To provide the best experience, we need access to your location.',
    required: false,
