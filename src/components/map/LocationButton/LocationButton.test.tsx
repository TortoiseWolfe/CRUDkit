...
describe('LocationButton', () => {
  ...
  it('should show granted state when permission is granted', () => {
    render(<LocationButton onClick={mockOnClick} permissionState="granted" hasLocation={true} />);
  ...
  it('should handle permission denied with hasLocation', () => {
    render(<LocationButton onClick={mockOnClick} permissionState="denied" hasLocation={true} />);
